...
- *(workflow)* Remove custom cache action from ci pipeline - ([21d8d26](https://git.0xmax42.io/maxp/clipcode/commit/21d8d2629c5e58d11d32236bbe40137ffb201f4a))
- *(ci)* Set gitea env vars for release asset upload - ([ca37b20](https://git.0xmax42.io/maxp/clipcode/commit/ca37b2054da8d1267f85bbd403dbe152724f4d68))
